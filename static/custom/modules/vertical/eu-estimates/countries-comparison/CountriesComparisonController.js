...
define(function (require) {
    ...
    function controller($scope, $rootScope, $window, $stateParams, $state, $log, CountriesComparisonService, dvtUtils, dataService, plotsProvider, $document, configService, $sce) {
    ...
    controller.$inject = ['$scope', '$rootScope', '$window', '$stateParams', '$state', '$log', 'countriesComparisonService', 'dvtUtils', 'dataService', 'plotsProvider', '$document', 'configService', '$sce'];
    return controller;
