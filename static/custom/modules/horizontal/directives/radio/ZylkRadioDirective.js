...
define(function (require) {
    ...
    function ZylkRadioDirective(dataService, $log) {
        return {
            restrict: 'E',
                        ...
                        if(attributes.extension == 'approaches') {
                            ...
                            dataService.getGroupingInformation().then(function (dataset) {
                                ...
                                [].forEach.call(options, function (option, index) {
                                    $log.debug("ZylkRadioDirective index isChecked: " + option.checked);
    ...
    ZylkRadioDirective.$inject = ['dataService', '$log'];

    return ZylkRadioDirective;
});
