/**
 * @ngdoc directive
 * @name dvt.charting.directive:ZylkShape
...
define(function (require) {
    ...
    function ZylkShapeDirective(dataService, mapProvider, $log, dvtUtils) {
        return {
            restrict: 'E',
    ...
    ZylkShapeDirective.$inject = ['dataService', 'mapProvider', '$log', 'dvtUtils'];

    return ZylkShapeDirective;
});
