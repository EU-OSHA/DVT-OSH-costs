/**
 * @ngdoc directive
 * @name dvt.directive:ZylkDashboard
 * @scope
 * @restrict E
 * @description
...
define(function (require) {
    ...
    function ZylkDashboardDirective($log, $q, $window, $timeout, $cookies) {
        ...
        return {
            ...
            , controller: ['$scope','$rootScope', function ($scope, $rootScope) {
                ...
                $scope.id = "zylk_dashboard" + nextId();
    ...
    ZylkDashboardDirective.$inject = ['$log', '$q','$window','$timeout','$cookies'];
    return ZylkDashboardDirective;
});